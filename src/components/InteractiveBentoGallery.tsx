            ...
            >
                ...
                <motion.button
                    className="absolute top-4 right-4 z-50
                              p-3 rounded-full bg-black/80 text-white hover:bg-black/90 
                              backdrop-blur-sm transition-all duration-200 border-2 border-white/30
                ...
                <motion.button
                    className="absolute left-2 sm:left-4 top-1/2 -translate-y-1/2
                              p-3 rounded-full bg-black/50 text-white hover:bg-black/70 
